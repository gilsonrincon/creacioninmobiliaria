...
<div id="search_block_top">
	<form method="get" action="{$link->getPageLink('search')|escape:'html'}" id="searchbox">
		<p>
			...
			<input type="hidden" name="orderby" value="position" />
			<input type="hidden" name="orderway" value="desc" />
			<input class="search_query" type="text" id="search_query_top" placeholder="Búsqueda por código ó palabra clave" name="search_query" value="{$search_query|escape:'htmlall':'UTF-8'|stripslashes}" />
